...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot vio_0 xil_defaultlib.vio_0 xil_defaultlib.glbl -log elaborate.log
}
